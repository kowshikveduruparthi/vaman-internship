...
{
    //Seven Segment GPIO
    PyHal_GPIO_Set(1,a);//a
    PyHal_GPIO_Set(2,b);//b
    PyHal_GPIO_Set(3,c);//c
    PyHal_GPIO_Set(4,d);//d
    PyHal_GPIO_Set(5,e);//e
    PyHal_GPIO_Set(8,f);//f
    PyHal_GPIO_Set(9,g);//g
}
...

{
    ...
    //Set GPIO direction
    PyHal_GPIO_SetDir(1,1);
    PyHal_GPIO_SetDir(2,1);
